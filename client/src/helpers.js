...
export const links = [
  ...
  { name: "Learn to cook", path: "/food" },
  { name: "Train for a marathon", path: "/fitness" },
  { name: "Build an app", path: "/tech" },
  { name: "Hike a mountain", path: "/outdoors" },
  { name: "Practice a language", path: "/languages" }
];
